...
var quiRootParent = document.createElement("div");
var quiRoot = document.createElement("div");
...
window.websdk.init(PlateauUIOptions, "qui").then(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, window.websdk.createRenderer({ mountPoint: quiRoot })];
            case 1:
                renderer = _a.sent();
                renderer.open();
                document.body.appendChild(quiRootParent);
                return [2 /*return*/];
        }
    });
}); });
