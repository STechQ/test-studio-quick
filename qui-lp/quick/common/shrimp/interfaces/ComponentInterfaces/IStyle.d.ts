...
export type StyleValue = Record<string, string | boolean | undefined | Record<string, string>>;
...
export type IAssetList = Record<string, Record<string, Record<string, string | StyleValue | undefined>>>;
